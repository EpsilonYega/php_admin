...
<form action="/update" method="POST">
  ...
  <div class="form-group">
    <label for="inputOldLogin">Введите старый логин пользователя</label>
    <input type="text" class="form-control" id="inputOldLogin" aria-describedby="inputOldLogin" placeholder="Логин" name="inputOldLogin">
    <small id="inputOldLoginSmall" class="form-text text-muted">Да, костыль..</small>
  </div>
  <div class="form-group">
